...
import com.yuki.experiment.framework.mapper.EventMapper;
import com.yuki.experiment.framework.mapper.ExperimentMapper;
import com.yuki.experiment.framework.mapper.PracticeMapper;
...
public class EventServiceImpl implements EventService {
    ...
    public List<JSONObject> getInfo(Date beginDate, Date endDate) {
        ...
        for (Calendar item = begin; item.getTime().getTime() <= endDate.getTime(); item.add(Calendar.DAY_OF_YEAR, 1)) {
